...
$(document).ready(function () {
  ...
  $('#combineArraysForm').on('submit', function (e) {
    e.preventDefault();
    $('#message').text('loading...').removeClass('valid not-valid');
    axios.post('/combine-arrays', {}).then(function (response) {
      if (response.data.message) {
        $('#message').text(response.data.message).removeClass('not-valid').addClass('valid');
      } else {
        $('#message').text('ERROR').removeClass('valid').addClass('not-valid');
  ...
  $('#foldersImageHandler').on('submit', function (e) {
    e.preventDefault();
    $('#message').text('loading...').removeClass('valid not-valid');
    axios.post('/create-files', {}).then(function (response) {
      if (response.data.message) {
        $('#message').text(response.data.message).removeClass('not-valid').addClass('valid');
      } else {
        $('#message').text('ERROR').removeClass('valid').addClass('not-valid');
  ...
  $('#createCsv').on('submit', function (e) {
    e.preventDefault();
    $('#message').text('loading...').removeClass('valid not-valid');
    axios.post('/create-csv', {}).then(function (response) {
      if (response.data.message) {
        $('#message').text(response.data.message).removeClass('not-valid').addClass('valid');
      } else {
        $('#message').text('ERROR').removeClass('valid').addClass('not-valid');
  ...
  $('#pageParser').on('submit', function (e) {
    e.preventDefault();
    $('#message').text('loading...').removeClass('valid not-valid');
    axios.post('/parse-page', {}).then(function (response) {
      if (response.data.message) {
        $('#message').text(response.data.message).removeClass('not-valid').addClass('valid');
      } else {
        $('#message').text('ERROR').removeClass('valid').addClass('not-valid');
  ...
  $('#fetchDb').on('submit', function (e) {
    e.preventDefault();
    $('#message').text('loading...').removeClass('valid not-valid');
    axios.post('/fetchdb', {}).then(function (response) {
      if (response.data.message) {
        $('#message').text(response.data.message).removeClass('not-valid').addClass('valid');
      } else {
        $('#message').text('ERROR').removeClass('valid').addClass('not-valid');
  ...
  $('#handleDb').on('submit', function (e) {
    e.preventDefault();
    $('#message').text('loading...').removeClass('valid not-valid');
    axios.post('/handledb', {}).then(function (response) {
      if (response.data.message) {
        $('#message').text(response.data.message).removeClass('not-valid').addClass('valid');
      } else {
        $('#message').text('ERROR').removeClass('valid').addClass('not-valid');
